...
from .views import (
    UserViewSet, SubjectViewSet, ClassViewSet, StudentViewSet, ParentViewSet,
    ExamViewSet, GradeViewSet, AttendanceViewSet, FeeViewSet, AnnouncementViewSet,
    MessageViewSet, TimetableViewSet, HomeworkViewSet, LibraryItemViewSet,
